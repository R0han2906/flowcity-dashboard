...
// ── Mode helpers ──────────────────────────────────────────────────────────────
const modeIcons: Record<string, any> = { metro: Train, bus: Bus, walk: Footprints };
    ...
    <motion.div variants={stagger} initial="hidden" animate="show" className="w-full max-w-[1200px] mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="relative z-10 bg-white/10 p-5 rounded-2xl backdrop-blur-md border border-white/10">
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <span className="text-[10px] font-medium text-white/40">Based on 0 active disruptions</span>
              </div>
            </div>
          </motion.div>
        ...
        <div className="space-y-8">
          ...
          {/* ══ LIVE LOCATION CARD ════════════════════════════════════════
              onNavigate is passed so clicking the map opens LiveMapScreen.
              LiveLocationCard stores coordinates in sessionStorage first,
              then LiveMapScreen reads them and centers the map there.
          ════════════════════════════════════════════════════════════════ */}
